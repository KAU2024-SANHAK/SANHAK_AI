...
좋은 예시는 다음과 같습니다.
{
    ...
    만약 유저가 제공한 정보가 너무 부족하다고 판단되어 다이어리를 작성할 수 없을 경우 '다이어리를 작성할 수 없습니다.' 라는 내용을 반환해주세요.
    """
